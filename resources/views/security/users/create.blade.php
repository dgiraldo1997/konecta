    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-primary">
                <div class="panel-heading"><span class="glyphicon glyphicon-user"></span> Nuevo Usuario</div>

                <div class="panel-body">
                    <!--VALIDACION DE ERRORES...-->
                    @include('errores')
                    {!! Form::open(['route'=>'security.users.store','method'=>'POST','name'=>'formulario','autocomplete'=>'off']) !!}
                    <div class='form-horizontal'>
                        <div class='form-group'>
                            {!! Form::label('lUsuario','Usuario:',['class'=>'col-sm-2 control-label']) !!}
                            <div class="col-sm-4">
                                <strong>{!! Form::text('username',null,['class'=>'form-control uppercase']) !!}</strong>
                            </div>
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            {!! Form::label('lPassword','Contraseña:',['class'=>'col-sm-2 control-label']) !!}
                            <div class="col-sm-4">
                    ...
                    <br>
                    {!! Form::button('Guardar',['type'=>'submit','value'=>'Guardar','class'=>'btn btn-success']) !!}
                    @include('security.users.partials.botonatras')
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
